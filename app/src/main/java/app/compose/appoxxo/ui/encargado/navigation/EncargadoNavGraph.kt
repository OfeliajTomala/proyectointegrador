package app.compose.appoxxo.ui.encargado.navigation
...
fun EncargadoNavGraph(
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            ...
            bottomBar = { AppBottomBarEncargado(navController, dashboardViewModel) }
        ) { innerPadding ->
            ...
            NavHost(
                ...
                composable(NavItem.ProductList.route) {
                    //Encargado SÍ puede agregar y editar productos
                    ProductListScreen(
                ...
                //ruta de agregar producto habilitada para Encargado
...
@Composable
private fun AppBottomBarEncargado(
    navController: NavHostController,
